...
export const getInitialDriversForUser = (_email?: string, name?: string): Driver[] => {
  const primaryName = name && name.trim() !== '' ? name.trim() : 'Hugo';
  
  return [
    { id: 'drv-hugo', name: primaryName, isDefault: true },
